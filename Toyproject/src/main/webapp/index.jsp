...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/templatemo-festava-live.css" rel="stylesheet">
    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="${pageContext.request.contextPath}/ticket.html" class="btn custom-btn d-lg-none ms-auto me-4">Buy Ticket</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/ticket.html" class="btn custom-btn d-lg-block d-none">Buy Ticket</a>
                        </li>
                        </c:if>
                    </ul>
					...
					<c:choose>
         				<c:when test="${member != null}">
                    			<a href="${pageContext.request.contextPath}/Logout.do" class="btn custom-btn d-lg-block d-none">Log Out</a>
						</c:when>
    					<c:otherwise>
                    		<a href="${pageContext.request.contextPath}/member/login.jsp" class="btn custom-btn d-lg-block d-none">Log In</a>
						</c:otherwise>
					</c:choose>
                </div>
            </div>
        ...
        <section class="hero-section" id="section_1">
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="${pageContext.request.contextPath}/video/pexels-2022395.mp4" type="video/mp4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="${pageContext.request.contextPath}/images/pexels-alexander-suhorucov-6457579.jpg" class="about-image img-fluid">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="${pageContext.request.contextPath}/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg"
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="${pageContext.request.contextPath}/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg"
                                    class="artists-image img-fluid">
                            </div>
                        ...
                        <div class="artists-thumb">
                            <img src="${pageContext.request.contextPath}/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg"
                                class="artists-image img-fluid">
...
-->
    ...
    <script src="${pageContext.request.contextPath}/js/click-scroll.js"></script>
